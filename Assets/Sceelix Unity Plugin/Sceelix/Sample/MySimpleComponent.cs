...
namespace Assets.Sceelix.Sample
{
    ...
    public class MySimpleComponent : MonoBehaviour
    {
        ...
        [ComponentProcessor("MySimpleComponent", priority: 0)]
        public static void MySimpleComponentProcessor(IGenerationContext context, GameObject gameObject, JToken jtoken)
        {
