...
namespace Assets.Sceelix.Sample
{
    /// <summary>
    /// This class demonstrates how you can instantiate your own custom materials defined in Sceelix.
    /// 
    /// You can create any new class in any location of your project to do this (prefable outside the Sceelix folder, actually). 
    /// 
    ...
    /// </summary>
    public class MyMaterialManagerSample
    {
        /// <summary>
        ...
        /// </summary>
        [MaterialProcessor("MySpecialMaterial")]
        public static Material MySpecialMaterialProcessor(IGenerationContext context, JToken jtoken)
        {
            ...
            mySpecialMaterial.mainTexture = DefaultMaterialManager.CreateOrGetTexture(context, jtoken["Properties"]["MyFirstTexture"]);
        ...
        /// </summary>
        [MaterialProcessor("MySpecialMaterial", priority: 10)]
        public static Material MyOverridingMaterialProcessor(IGenerationContext context, JToken jtoken)
        {
            ...
            if (style == "Simple")
            {
                ...
                mySpecialMaterial.mainTexture = DefaultMaterialManager.CreateOrGetTexture(context, jtoken["Properties"]["MyTexture"]);
            ...
            if (style == "Existing")
            {
                ...
                return DefaultMaterialManager.SingleTextureMaterialProcessor(context, jtoken);
            }
            if (style == "From Disk")
            {
                ...
                existingMaterial.SetTexture("_MainTex", DefaultMaterialManager.CreateOrGetTexture(context, jtoken["Properties"]["MyTexture"]));
